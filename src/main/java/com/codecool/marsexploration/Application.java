...
import com.codecool.marsexploration.service.map.*;
...
public class Application {
    private static final MapProvider MAP_PROVIDER = new MapGenerator();
...
//    private static final Map<CellType, ShapeGenerator> SHAPE_GENERATORS = Map.of(
//            CellType.MOUNTAIN, new ShapeGenerator(),
//            CellType.PIT, new ShapeGenerator());
